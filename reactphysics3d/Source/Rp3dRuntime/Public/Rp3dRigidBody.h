...
struct RP3DRUNTIME_API FRp3dCollider
{
    ...
    void Initialize(reactphysics3d::Collider* Co, TWeakPtr<reactphysics3d::RigidBody> Rb);
private:
    reactphysics3d::Collider* Collider;
    TWeakPtr<reactphysics3d::RigidBody> RigidBody;
};


class RP3DRUNTIME_API FRp3dRigidBody
{
public:
    FRp3dRigidBody(class FRp3dPhysicsWorld* World);
...
private:
	TSharedPtr<FRp3dRigidBody> RigidBody;
    UPROPERTY()
